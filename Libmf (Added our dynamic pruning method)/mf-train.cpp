...
{
    auto start_t1 = system_clock::now();
    ...
    else
    {
        ...
        if (!option.on_disk)
            ...
            model = mf_train_with_validation_on_disk(option.tr_path.c_str(),
                ...
                option.param);
        //duration<double> diff1 = system_clock::now() - start2;
        //cout << "model time is:  "<< diff1.count()<< "seconds"<< endl;
    ...
    //double diff_t2 = end_t2.tv_sec - start_t2.tv_sec  + (end_t2.tv_usec - start_t2.tv_usec)*0.000001;
    duration<double> diff_t1 = system_clock::now() - start_t1;
    cout << "total time is:  " << diff_t1.count() << "  seconds" << endl;
    //cout << "total time1 is:  "<< diff_t2<< "seconds"<< endl;
